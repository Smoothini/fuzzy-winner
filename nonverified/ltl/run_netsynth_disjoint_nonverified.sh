...
do
	echo "Running Disjoint_$i non satisfied.."
	{ time timeout -k 1s 15m ./netsynth solve ltl/nonsatisfied/Disjoint_$i.ltl ; } 2> ltl_results/nonsatisfied/Disjoint/Disjoint_$i.txt 
	echo "Done!"
done
echo "Run done!"
